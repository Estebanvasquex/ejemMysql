...
SELECT apellido, nombre, fecha_nacimiento, DATE_FORMAT(fecha_nacimiento, '%W, %e de %M de %Y') FROM usuario;
...
SELECT 5%2;
SELECT id, IF(id%2 = 0, 'PAR', 'IMPAR') AS paridad, apellido, nombre FROM usuario; 
